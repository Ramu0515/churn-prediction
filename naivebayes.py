...
conf.setAll([('spark.executor.memory', '4g'), ('spark.executor.cores', '4'), ('spark.driver.memory','4g')])
...
df=df.na.fill(0)
df=df.select(['churn','rev_Mean','mou_Mean','totmrc_Mean'])
